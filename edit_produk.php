            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form method="POST" action="proses_produk.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    ...
                                    <input id="berat" name="berat" value="<?=$row['berat']?>" type="text"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="gambar" class="col-4 col-form-label">Link Gambar</label>
                            <div class="col-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <input id="gambar" name="gambar" type="text" class="form-control"
                                        value="<?=$row['gambar']?>">
                                </div>
                            </div>
                        </div>
