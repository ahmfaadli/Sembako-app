            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark bg-success" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="list_jenis.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Jenis
                        </a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a class="btn btn-warning" href="create_jenis.php">Create Jenis</a>
                    <table class="table table-hover text-center table-bordered" width="100%" border="1" cellspacing="2"
                        cellpadding="2">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href="delete_jenis.php?iddel=<?= $row['id'] ?>"
                                        onclick="return confirm('Anda Yakin Hapus Data Kartu <?= $row['jenis_produk'] ?>?')">Delete</a>
                                </td>
                            </tr>
                            <?php 
                                $nomor++;   
